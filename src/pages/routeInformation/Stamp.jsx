        ...
        {stamp.slice(0, 3).map((item, index) => (
          <div key={index} className={styles.stampCard}>
            ...
            <div className={styles.cardHeader}>
              <img src={item.stamp_img} alt="stampimg" style={{ width: '150px', height: '120px' }} />
            ...
            <div className={styles.cardDetails}>
              ...
              <div style={{ marginTop: '20px' }}>
                連結: <a className={styles.link} href={item.link} target="_blank" rel="noopener noreferrer">{item.link}</a>
              </div>
            </div>
          </div>
        ))}
