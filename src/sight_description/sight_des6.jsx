...
const Sight_des1 = () => {
  ...
  useEffect(() => {
    fetch('https://test-camino.onrender.com/data?table=img')
      ...
      .then(data => {
        ...
        const ImgData_1 = data.find(item => item.target_id === 16)
  ...
  useEffect(() => {
    fetch('https://test-camino.onrender.com/data?table=img')
      ...
      .then(data => {
        ...
        const ImgData_2 = data.find(item => item.target_id === 16)
  ...
  useEffect(() => {
    fetch('https://test-camino.onrender.com/data?table=sight')
      .then(res => res.json())
      .then(data => {
        const description = data.find(item => Number(item.sight_id) === 6)
