...
const pathsData = [
  {
    ...
    stroke: "#c8d119",
    cardStyle: { position: "absolute", top: "25%", left: "52%" },
  },
  {
    id: "2",
    ...
    stroke: "#DD3074",
    cardStyle: { position: "absolute", top: "60%", left: "42.5%" },
  },
  {
    id: "3",
  ...
  },
  {
    ...
    stroke: "#C12528",
    cardStyle: { position: "absolute", top: "20%", left: "30%" },
  },
  {
    id: "6",
    ...
    stroke: "#2B2F89",
    cardStyle: { position: "absolute", top: "45%", left: "27%" },
  },
];

function MapRoute(style) {
