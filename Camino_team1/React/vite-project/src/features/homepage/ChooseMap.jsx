...
const pathsData = [
  {
    ...
    stroke: "#c8d119",
    cardStyle: { position: "absolute", top: "35%", left: "52%" },
  },
  {
    id: "2",
    ...
    stroke: "#DD3074",
    cardStyle: { position: "absolute", top: "55%", left: "47%" },
  },
  {
    id: "3",
  ...
  },
  {
    ...
    stroke: "#C12528",
    cardStyle: { position: "absolute", top: "26%", left: "32%" },
  },
  {
    id: "6",
...
export default function ChooseMap({ routes, setRouteId }) {
          ...
          {pathsData.map((path) => (
            <g key={path.id}>
              <path
                d={path.d}
                fill="none"
                stroke={hoveredPath?.id === path.id ? "orange" : path.stroke}
                strokeWidth="10"
                strokeLinecap="round"
              ...
              <path
                ...
                stroke="transparent"
                strokeWidth="40"
                onMouseEnter={() => setHoveredPath({ id: path.id })}
                onMouseLeave={() => setHoveredPath(null)}
                onClick={() => setRouteId(Number(path.id))}
