...
import CheckoutSteps from "../../packageTour/page4/CheckoutSteps";
import PassengerForm from "../../packageTour/page4/PassengerForm";
import ContactForm from "../../packageTour/page4/ContactForm";
import EmergencyContact from "../../packageTour/page4/EmergencyContact";
import FlightInfo from "../../packageTour/page4/FlightInfo";
import AccommodationList from "../../packageTour/page4/AccommodationList";
import AmountSummary from "../../packageTour/page4/AmountSummary";
...
function P_4_package() {
  ...
  const goToPage5 = () => {
    navigate("/page5", { state: { routeId, totalAmount } });
  };
